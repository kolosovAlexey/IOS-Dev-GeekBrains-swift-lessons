...
// Скрыл код в многострочный комментарий, чтобы было легче проверять по одному заданию удаляя /*  */
...
var result = calculationOfProfit(depositAmount, yearPercentage, numOfYears)
print(result)
